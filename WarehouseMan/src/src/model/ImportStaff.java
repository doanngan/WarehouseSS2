...
public class ImportStaff {
	...
	@DAssoc(ascName = "importStaff-has-address", role = "importStaff", ascType = AssocType.One2Many, endType = AssocEndType.Many, associate = @Associate(type = Address.class, cardMin = 1, cardMax = 10))
	private Address address;

	@DOpt(type = DOpt.Type.ObjectFormConstructor)

	public ImportStaff(@AttrRef("name") String name, @AttrRef("phone") String phone, @AttrRef("email") String email,
			@AttrRef("address") Address address) {
		this(null, name, phone, email, address);
	}

	@DOpt(type = DOpt.Type.DataSourceConstructor)
	public ImportStaff(Integer id, String name, String phone, String email, Address address) {
		this.id = nextID(id);
		this.name = name;
